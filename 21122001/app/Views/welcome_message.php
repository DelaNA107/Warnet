...
<header>
    ...
    <div class="heroe">
        ...
        <h1>Selamat Datang di Website "Dela Nur Anisa" </h1>

        <h2>Ini digunakan untuk menunjukkan kompetensi saya dalam menggunakan framework HMVC dalam pengembangan aplikasi web serta mengelola source code menggunakan sistem control versi GIT</h2>
