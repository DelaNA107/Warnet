                ...
                <table class="table table-bordered text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        ...
                        <tr>
                            ...
                            <td class="align-middle"><a href="#" data-href="<?= base_url('cart/'.$brglist['id_detail'].'/delete') ?>" onclick="confirmToDelete(this)" class="btn btn-sm btn-primary"><i class="fa fa-times"></i></a>
                            </td>
                        </tr>
                        <?php endforeach ?>
                    </tbody>
